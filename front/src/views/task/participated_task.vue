<template>
  <div class="my_task" style="font-family: 'jdjszhong'; font-weight: bold; display:block;">
    <!-- <div class="dashboard-text">name: {{ name }}</div> -->
    <h1> My Application </h1>
    <div class="box" style="font-family: 'jdjszhong'; font-weight: bold; display:block;">
      <el-row>
      ...
      class='box row' style="font-family: 'jdjszhong'; font-weight: bold; display:block;">
        <div>
          <el-row>
            ...
            <el-col :span="2"> <el-button type="primary" @click="drawer = true" style="font-family: 'jdjszhong'; font-weight: bold; display:block; ">Chat</el-button>  </el-col>
            <el-col :span="2"> <el-button type="success" @click="drawer = true" style="font-family: 'jdjszhong'; font-weight: bold; display:block; position: relative; left: -5px">Accept</el-button>  </el-col>
            <el-col :span="2"> <el-button type="warning" @click="drawer = true" style="font-family: 'jdjszhong'; font-weight: bold; display:block;">Reject</el-button> </el-col>
          </el-row>
        </div>
        <el-drawer
          title=""
          ...
          <div class="chat">
            ...
            <div class="input">
              ...
              <el-col :span="4"> <el-button type="primary" style="font-family: 'jdjszhong'; font-weight: bold; display:block;">Send</el-button> </el-col>
              </el-row>
            </div>
          </div>
        </el-drawer>
